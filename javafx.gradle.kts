...
val jfxDependenciesFile = project("GMCL").buildDir.resolve("openjfx-dependencies.json")
val jfxPlatforms = listOf(
    Platform("windows-x86", "win-x86"),
    Platform("windows-x86_64", "win"),
    Platform("windows-arm64", "win", groupId = "fun.fotontv.gmcl.openjfx", version = "18.0.2+1-arm64", unsupportedModules = listOf("media", "web")),
    ...
    Platform("linux-loongarch64_ow", "linux", groupId = "fun.fotontv.gmcl.openjfx", version = "19-ea+10-loongson64", unsupportedModules = listOf("media", "web")),
)
